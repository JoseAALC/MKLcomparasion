...
results_file=open("Reports//"+dataset_name+"_MKL2results.csv","w")
report_file=open("Reports//"+dataset_name+"_MKL2report.txt","w")
pred_file=open("Reports//"+dataset_name+"_predictions2.txt","w")
...
kernels_indexes = [[i for i in range(110*110)] for j in range(20)] + [[i for i in range(110*110,110*110*2)] for j in range(20)]
parameters3 ={
...
fitness_report=open("Reports//"+dataset_name+"fitness2.txt","w")
